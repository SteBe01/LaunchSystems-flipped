...
[m_case_a, mtot_case_a, mprop_case_a] = TANDEM(Is_case_a, eps_case_a, dv, m_pay);
...
[m_case_b, mtot_case_b, mprop_case_b] = TANDEM(Is_case_b, eps_case_b, dv, m_pay);
...
[m_case_c, mtot_case_c, mprop_case_c] = TANDEM(Is_case_c, eps_case_c, dv, m_pay);
...
[m_case_2, mtot_case_2, mprop_case_2] = TANDEM(Is_case_2, eps_case_2, dv, m_pay);
